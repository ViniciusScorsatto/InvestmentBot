...
def initialize_db() -> None:
    with get_db() as connection:
        ...
        for statement in (
            ...
            "ALTER TABLE trades ADD COLUMN IF NOT EXISTS runner_activated BOOLEAN DEFAULT FALSE",
            "ALTER TABLE trades ADD COLUMN IF NOT EXISTS runner_activated_at TIMESTAMPTZ",
        ):
